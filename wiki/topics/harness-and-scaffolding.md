...
**Why**: Dean builds on and inside harnesses (Claude Code, custom agent loops in Crafted/Praxis); this vocabulary is the precise language for reasoning about which layer owns a behavior, and it's converging right now.
