...
**Why**: This is the substrate behind Crafted/Praxis retrieval over Qdrant — hybrid + RRF + cross-encoder rerank is the most likely concrete upgrade to his current dual-collection setup.
