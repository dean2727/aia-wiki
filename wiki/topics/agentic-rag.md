...
**Why**: Crafted/Praxis already uses OpenRouter (Claude/Gemini) with function calling — wrapping Qdrant retrieval in a retrieve-evaluate-reformulate loop is a natural, incremental upgrade over the current static pipeline.
