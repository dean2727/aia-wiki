...
**Fit score**: 4/10
**Adoption path**: watch
**Why**: Crafted/Praxis retrieval is local/factoid over Qdrant, not corpus-level QFS — GraphRAG's indexing cost isn't justified unless a "summarize across all of a user's data" feature emerges.
